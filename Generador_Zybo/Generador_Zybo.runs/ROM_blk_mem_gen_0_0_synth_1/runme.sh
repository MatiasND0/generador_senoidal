...
HD_PWD='C:/Users/matia/Desktop/prueba/Generador_Zybo/Generador_Zybo.runs/ROM_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_blk_mem_gen_0_0.tcl
