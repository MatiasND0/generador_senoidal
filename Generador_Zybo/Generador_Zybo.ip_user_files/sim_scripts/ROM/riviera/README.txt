...
#
# Generated by export_simulation on Tue Jul 11 17:37:37 -0300 2023
#
################################################################################
...
'-reset_run' switch to the './ROM.sh' script.
...
./ROM.sh -noclean_files

For more information on the script, please type './ROM.sh -help'.
